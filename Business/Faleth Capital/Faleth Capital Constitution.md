...
4. Once the subsidiary generates $1 million per year in collected income for the office, the founder earns Class A membership and receives Class A shares.
...
Class A membership, once earned, is permanent. A member's shares and status cannot be revoked for performance reasons. However:

- A member can be voted out of active governance by the other Class A members. This removes their participation in office-level decision-making but does not strip their shares or economic interests from their subsidiary.
- A member can voluntarily sell their Class A position and exit the office.
- A member's subsidiary continues to operate under the same terms regardless of the member's governance status.

The principle is that membership represents a permanent recognition of what someone built, but active governance is a responsibility that requires the ongoing confidence of one's peers — the same principle that applies to Elected Leads within subsidiaries.
...
- Admission of new Class A members upon reaching the $1M threshold.
- Votes to remove a member from active governance.
...
This is not a concession. It is a structural commitment. People who want to leave should be able to. People who stay should do so willingly. The goal is not to make separation costless, but to make it possible — without betrayal, destruction of value, or the slow buildup of resentment that quietly poisons everything it touches.
...
**Protection of Earned Stakes.** Every participant keeps what they built. Cumulative contribution history, minted Class B shares, and proportional claims on equity and profit share travel with the person, not with the subsidiary.

**Bottom-Up Decision Making.** Separation decisions are driven by the people doing the work. The office's role is to facilitate a fair financial separation, not to dictate its outcome.

**Minimize Harm.** The process is designed to be clean, transparent, and as non-disruptive as possible — to those leaving and those who remain.

## 5.3 — The Peaceful Fork

When a group of participants no longer wishes to operate under Faleth Capital — whether due to a shift in direction, a loss of trust in leadership, or a desire to build something independent — the system provides a structured path for peaceful separation.

The general shape of a fork:

- The intent to separate is communicated openly within the subsidiary.
- The team — not the office, not the founder — determines the structure of the split through a vote.
- Those who stay retain the existing subsidiary, its name, its operations, and its Faleth Capital affiliation.
- Those who leave may form an independent entity and receive a prorated share of assets based on their collective contribution history, valued at book value.
- Faleth Capital is made whole on its proportionate capital contribution before assets transfer, protecting the shared liquidity pool for everyone who remains in the system.
- All earned Class B shares are retained by their holders regardless of which side they choose.

The specific terms of any fork — thresholds, timelines, transition agreements — are negotiated in good faith at the time of separation, guided by these principles. The principles are fixed. The process is flexible.

## 5.4 — The Office's Role

Faleth Capital does not determine who stays and who goes. A founder cannot unilaterally remove a subsidiary from the portfolio without team consent. A dissatisfied group cannot be held hostage by a founder or the office.

The office's function in a separation is narrow: ensure the process honors these principles, and protect the liquidity reserve so the shared pool remains intact for those who remain and the builders who come next.

This mechanism reinforces the bottom-up nature of the system. It is reviewed at each quarterly earnings call and may be refined by Class A members, provided the three core principles — no trapping, book-value valuation, and protection of earned stakes — remain inviolable.
...
- The three core principles of the Separation and Peaceful Fork mechanism: no trapping, the book-value valuation standard, and the protection of earned stakes (Article V, Section 5.2).
...
And for that, I feel it is necessary at the end of this document to at least reveal the motives behind **why** this exists to begin with. It can be easy to read these frameworks and think "this sounds too good to be true... why would anyone try and make me generationally wealthy unless they were trying to get something from me?". But here is the reality:
...
Everything in this document — the Contribution Framework, the equity pipeline, the network marketing spine, the referral program, the MCA structure, the Peaceful Fork — exists to prove that isn't a universal truth. It never was until about 200 years ago. This exists to prove that you can outcompete through being a giver, not a taker. This exists to give someone who starts with nothing a real, honest, structured path to ownership, freedom, and generational wealth. Not a lottery ticket. Not a get-rich-quick scheme. A path. One that rewards effort, develops character, and compounds over time. It is there for those who choose to walk it.

The human mind, without the Holy Spirit, craves control. Because control breeds predictability. Predictability breeds survival. Predictability means "I can rest and live". Unpredictability breeds anxiety. Anxiety brings about thoughts of death as a possibility. Death is unacceptable. Every fear, rooted towards its origin, is the same: the fear of death. The flesh wants one thing, and one thing alone: existence in perpetuity. This is why it is so hard for us to give up our stable paycheck. But one rooted in Christ fears no such things. If you know that you will be fine, no matter what happens, because the literal ***Heavenly Creator of the universe*** is personally watching over you, you would jump off a bridge just to prove it. That is the person we will attract. That is the person we will build.

I ultimately want this to be the new standard. Not just a Faleth Capital thing. A way of doing business that spreads because it is undeniably better — better for the people doing the work, better for the customers, better for the investors, better for everyone who touches it. People are tomatoes, the moment we stop growing, we die. We *need* something to build towards with intensity. And rather than try and convince shareholders of an unproven idea, we are just going to run with it. We are going to try it out. We are going to iron out the kinks through trial and error. But we have a vision. And if it turns out to be successful? We will get copycats. *That is the point.* I beg of you to copy us. Why? *Because this is bigger than me.* This is bigger than any one individual organization. That is why these documents are open source. Hell, I'll show you exactly how we did it and what we learned. If it means the propagation of human purpose, people get control over their lives again and can finally decide what they want out of life, not just what job they will be known for, I believe that is a worthy cause to lose money over.
