---
title: "Lyle X Share — Dogan Ural For You algorithm Grok Bot summary"
type: raw-transcript
created: 2026-08-13
source_url: https://x.com/doganuraldesign/status/2087969186219778252
source_author: "Dogan Ural (@doganuraldesign)"
status_id: "2087969186219778252"
ingested: 2026-08-13T19:05:00+00:00
sha256: bc19498e101d75d4491493b67d6e1d23d0dd4715c9de24d5112e7981589dbbef
tags: [lyle-x-share, x-ingest, x-algorithm, content]
---

# Lyle X Share — Dogan Ural For You algorithm Grok Bot summary

## Source post

Author: Dogan Ural ([@doganuraldesign](https://x.com/doganuraldesign))
Posted: 2026-08-13 18:27 UTC
Status: [2087969186219778252](https://x.com/doganuraldesign/status/2087969186219778252)

Attached image is a title card only: "AGU 13, 2026 / For You Timeline Algorithm Summary by Grok Bot" with an X mark. No weights on the image.

API metrics at ingest: ~268k impressions, 150 likes, 34 replies, 32 quotes, 20 reposts, 126 bookmarks.

## Full note text (verbatim)
...
[2087975673478398209](https://x.com/doganuraldesign/status/2087975673478398209) — reply to @TGBA2023:

> Here’s the Grok Bot’s answer. If this is true, that’s concerning. It’d be pretty easy to game this.
>
> “No. Muting or blocking other people does not cut your score or your reach.
>
> Those weights (−58.8 mute, −31.2 block) hit the account being muted/blocked, when the model thinks a [reader will do that to you].”

API text truncated at the last clause; meaning is: mute/block penalties apply to the target, not to the person doing the muting.

## Evidence classification

- Verbatim long-post text: retrieved via X API `note_tweet` on 2026-08-13.
- Image: title card only; no additional claims.
- Substance: second-hand Grok Bot reading of `xai-org/x-algorithm` as of a claimed 12 Aug 2026 sync. Public linear weights, not the unpublished transformer weights.
- Treat as a high-resolution operator map, not as independently re-audited source code in this ingest.
...
- [[faleth/content/systematic-x-voice-layer-printer-2026]]
